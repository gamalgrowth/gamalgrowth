(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_1dbc52e7._.js", {
...
"[project]/app/my-thoughts/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function MyThoughtsPage() {
    ...
    const fetchPosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "MyThoughtsPage.useCallback[fetchPosts]": async (pageNum)=>{
            setIsLoading(true);
            try {
                const response = await fetch(`/api/posts?page=${pageNum}&limit=6`);
                const data = await response.json();
                setPosts({
                    "MyThoughtsPage.useCallback[fetchPosts]": (prev)=>pageNum === 1 ? data.posts : [
                            ...prev,
                            ...data.posts
                        ]
                }["MyThoughtsPage.useCallback[fetchPosts]"]);
...
_s(MyThoughtsPage, "V4jcjLfAEpzNrdHfBIK4p2hIlVE=");
_c = MyThoughtsPage;
var _c;
...
//# sourceMappingURL=_1dbc52e7._.js.map