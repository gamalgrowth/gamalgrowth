  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white overflow-hidden min-h-[700px]">
        ...
        <div className="absolute right-0 top-0 w-2/3 md:w-1/2 h-full opacity-25">
          <img src="/images/Gamal-photo.png" alt="Mohamed Gamal" className="w-full h-full object-cover object-center" />
        </div>
